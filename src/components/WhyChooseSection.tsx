...
const Benefit = ({ title, description, icon }: BenefitProps) => (
  <div className="bg-white shadow-brand p-6 sm:p-8 rounded-xl text-center transform hover:scale-105 transition-all duration-200">
    ...
    <p className="text-sm sm:text-base text-brand-body">{description}</p>
  </div>
);
