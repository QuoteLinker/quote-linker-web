...
export default function HeroSection({ title, subtitle, ctaText, ctaLink, insuranceType }: HeroSectionProps) {
  return (
    <section className="bg-gradient-to-r from-brand-primary to-brand-primary-dark py-32 relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href={ctaLink}
            className="inline-flex bg-white text-brand-primary px-8 py-4 rounded-xl shadow-brand hover:shadow-2xl transition-all duration-200 transform hover:scale-105 font-semibold"
          >
            {ctaText}
          </a>
