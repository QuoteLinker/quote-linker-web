...
export const ShortTermDisabilityForm: React.FC = () => {
  const [currentStep, setCurrentStep] = useState(1);
  const [formData, setFormData] = useState<ShortTermDisabilityFormData>({
    isEmployed: '',
    worksOver30Hours: '',
    benefitAmount: '',
    firstName: '',
  ...
  const validateStep1 = (): boolean => {
    ...
    const worksOver30HoursError = validateSelect(formData.worksOver30Hours, 'Work hours');
    if (worksOver30HoursError) newErrors.worksOver30Hours = worksOver30HoursError;

    const benefitAmountError = validateBenefitAmount(formData.benefitAmount);
    if (benefitAmountError) newErrors.benefitAmount = benefitAmountError;
        ...
        <div className="space-y-6">
          <div>
            ...
            <select
              ...
              className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.isEmployed ? 'border-red-500' : ''}`}
            >
              <option value="">Select an option</option>
              <option value="yes">Yes</option>
              <option value="no">No</option>
            </select>
            {errors.isEmployed && <p className="mt-1 text-sm text-red-600">{errors.isEmployed}</p>}
          </div>
          ...
          <div>
            ...
            <select
              ...
              value={formData.worksOver30Hours}
              onChange={handleChange}
              className={`mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 ${errors.worksOver30Hours ? 'border-red-500' : ''}`}
            >
              <option value="">Select an option</option>
              <option value="yes">Yes</option>
              <option value="no">No</option>
        ...
        <div className="space-y-6">
          ...
          <div className="flex justify-between">
            ...
            <button
              ...
              data-event="stdi_insurance_quote_submit"
