			...
			<nav className="container mx-auto px-4 sm:px-6 lg:px-8" aria-label="Top">
				<div className="flex items-center justify-between h-16">
					...
					<div className="flex items-center">
						...
						{/* Mobile menu button and panel wrapped in a single Popover */}
							...
							<Popover as="div" className="relative">
								{({ open, close: closeMobileMenu }) => (
									<>
										...
										{/* Mobile menu panel, controlled by Popover's 'open' state */}
													...
													<Popover.Panel focus className="absolute top-0 inset-x-0 p-2 transition transform origin-top-right z-50 md:hidden">
														<div className="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
															<div className="px-5 pt-4 flex items-center justify-between">
																...
																<div className="-mr-2">
																	{/* This Popover.Button is inside the Popover.Panel, so it will close the popover by default */}
															...
															<div className="px-2 pt-2 pb-3 space-y-1">
																{insuranceProducts.map((item) => (
																	<Link
																		...
																		onClick={() => closeMobileMenu()} // Explicitly close on link click
																	>
																		{item.name}
																	</Link>
																))}
