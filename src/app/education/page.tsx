      ...
      <div className="min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {articles.map(article => (
                <Link
                  ...
                  className="group bg-white rounded-lg shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden border border-gray-100 flex flex-col"
                >
                  ...
                  <div className="p-4 sm:p-5 flex flex-col flex-grow">
                    <div className="mb-auto">
                      <span className="inline-block px-2.5 py-1 text-xs font-medium text-[#00EEFD] bg-[#00EEFD]/10 rounded-full mb-3">
                        {article.category}
                      </span>
                      <h2 className="text-lg font-semibold text-gray-900 mb-2 line-clamp-2 group-hover:text-[#00EEFD] transition-colors duration-200">
                        {article.title}
                      </h2>
        ...
        <div className="bg-gray-50 py-12 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <Link
              href="/contact"
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-[#00EEFD] hover:bg-[#00D4E5] transition-colors duration-200 shadow-sm hover:shadow"
            >
              Get a Free Quote
            </Link>
          </div>
