  ...
  return (
    <div className="bg-white">
      ...
      <HeroSection
        ...
        ctaText="Get My Disability Quote"
        ctaLink="#quote-form"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Why Choose Disability Insurance Through QuoteLinker
            </p>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div>
              <h2 className="text-3xl font-extrabold text-gray-900 sm:text-4xl">
                Ready to find your perfect disability insurance match?
              </h2>
            ...
            <div className="mt-8 lg:mt-0">
              <QuoteForm insuranceType="disability" />
            </div>
          </div>
        </div>
      </div>

      <StickyCTA insuranceType="disability" />
    </div>
  );
} 